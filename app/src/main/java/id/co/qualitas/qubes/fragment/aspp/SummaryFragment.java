...
//                    ((MainActivity) getActivity()).changePage(1);
    ...
    private void initData() {
        mList = new ArrayList<>();
        mList.add(new Order("ORDER000001", "1000000", "0WJ42 - SARI SARI (TK)", "SO0000001", "Approve", "1 June 2023"));
        mList.add(new Order("ORDER000002", "2000000", "0WJ42 - SARI SARI (TK)", "-", "Reject", "2 June 2023"));
        mList.add(new Order("ORDER000003", "3000000", "0WJ42 - SARI SARI (TK)", "SO0000003", "Pending", "3 June 2023"));
        mList.add(new Order("ORDER000004", "4000000", "0WJ42 - SARI SARI (TK)", "-", "Sync Success", "4 June 2023"));
    }
