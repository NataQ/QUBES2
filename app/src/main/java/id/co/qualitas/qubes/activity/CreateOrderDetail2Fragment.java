...
public class CreateOrderDetail2Fragment extends BaseFragment implements SearchView.OnQueryTextListener {
    ...
    private ImageView imgAttachment, imgSearch;
...
//    private Button btnNewMaterial;
    ...
    private TextView txtTargetMonth, txtTargetCall, txtSisa, txtAchiev, txtLine,
            txtMaterial, txtQtyUomN, txtTotalMat,
...
//                scroll.clearFocus();
    ...
    public void initialize() {
        ...
        txtTotalMat = rootView.findViewById(R.id.txtTotalMat);
...
//        btnNewMaterial = rootView.findViewById(R.id.btnAdd);
        btnNewMaterial = rootView.findViewById(R.id.btnAddMaterial);
        ...
        if (savedHeader != null) {
            if (savedHeader.getId() != null) {
                edtId.setText("Order Plan : " + savedHeader.getId());
            }
        }
...
//                                            return null;
        ...
        txtTotalMat.setText("Total Material : " + String.valueOf(visitOrderDetailResponseList.size()));
    }
