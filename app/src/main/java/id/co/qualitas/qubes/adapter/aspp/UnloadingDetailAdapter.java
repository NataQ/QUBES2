...
import id.co.qualitas.qubes.activity.aspp.UnloadingDetailActivity;
import id.co.qualitas.qubes.model.Material;

public class UnloadingDetailAdapter extends RecyclerView.Adapter<UnloadingDetailAdapter.Holder> implements Filterable {
    private List<Material> mList;
    private List<Material> mFilteredList;
    private LayoutInflater mInflater;
    private UnloadingDetailActivity mContext;
    private OnAdapterListener onAdapterListener;

    public UnloadingDetailAdapter(UnloadingDetailActivity mContext, List<Material> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.aspp_row_view_unloading_detail, parent, false);
