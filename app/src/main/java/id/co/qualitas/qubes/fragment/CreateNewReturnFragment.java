...
public class CreateNewReturnFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_create_return, container, false);

        getActivity().setTitle(getString(R.string.navmenu5dz));
            ...
            public boolean onTouch(final View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        dateBRBPickerDialog = new DatePickerDialog(
                                getActivity(),
