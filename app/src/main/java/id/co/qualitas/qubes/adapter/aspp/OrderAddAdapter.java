...
public class OrderAddAdapter extends RecyclerView.Adapter<OrderAddAdapter.Holder> implements Filterable {
    ...
    public class Holder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView imgDelete, imgViewPrice;
        ...
        public Holder(View itemView, OnAdapterListener onAdapterListener) {
            ...
            imgViewPrice = itemView.findViewById(R.id.imgViewPrice);
            imgDelete = itemView.findViewById(R.id.imgDelete);
            this.onAdapterListener = onAdapterListener;
            itemView.setOnClickListener(this);

            imgViewPrice.setOnClickListener(v -> {
                LayoutInflater inflater = LayoutInflater.from(mContext);
                DisplayMetrics metrics = mContext.getResources().getDisplayMetrics();
                int width = metrics.widthPixels;
                int height = metrics.heightPixels;

                View dialogview = inflater.inflate(R.layout.custom_dialog_price, null);
