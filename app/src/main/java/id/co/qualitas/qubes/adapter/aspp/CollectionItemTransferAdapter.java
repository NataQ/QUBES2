...
public class CollectionItemTransferAdapter extends RecyclerView.Adapter<CollectionItemTransferAdapter.Holder> implements Filterable {
    ...
    public CollectionItemTransferAdapter(CollectionFormActivityNew mContext, CollectionTransferNewAdapter headerAdapter, CollectionInvoiceTransferAdapter invoiceAdapter, int idHeader, int invoicePosition, List<Material> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
