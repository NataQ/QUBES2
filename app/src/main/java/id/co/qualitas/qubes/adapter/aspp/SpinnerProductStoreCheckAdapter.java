...
public class SpinnerProductStoreCheckAdapter extends RecyclerView.Adapter<SpinnerProductStoreCheckAdapter.Holder> implements Filterable {
    ...
    public SpinnerProductStoreCheckAdapter(StoreCheckActivity mContext, List<Material> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
