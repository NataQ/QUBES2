...
public class SpinnerCustomerAdapter extends RecyclerView.Adapter<SpinnerCustomerAdapter.Holder> implements Filterable {
    ...
    public SpinnerCustomerAdapter(Context mContext, List<Customer> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.text1.setText(detail.getId() + " - " + detail.getNama());
    ...
    public interface OnAdapterListener {
        void onAdapterClick(Customer String, int adapterPosition);
    }
}
