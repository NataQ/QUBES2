...
public class CollectionInvoiceGiroAdapter extends RecyclerView.Adapter<CollectionInvoiceGiroAdapter.Holder> implements Filterable {
    ...
    public CollectionInvoiceGiroAdapter(CollectionFormActivityNew mContext, CollectionGiroNewAdapter headerAdapter, int idHeader, List<Invoice> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
    ...
    public void onBindViewHolder(Holder holder, int pos) {
        ...
        mAdapter = new CollectionItemGiroAdapter(mContext, headerAdapter, CollectionInvoiceGiroAdapter.this, idHeader, holder.getAbsoluteAdapterPosition(), mFilteredList.get(holder.getAbsoluteAdapterPosition()).getMaterialList(), header -> {
