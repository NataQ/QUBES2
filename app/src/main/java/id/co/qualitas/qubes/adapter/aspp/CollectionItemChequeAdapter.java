...
public class CollectionItemChequeAdapter extends RecyclerView.Adapter<CollectionItemChequeAdapter.Holder> implements Filterable {
    ...
    public CollectionItemChequeAdapter(CollectionFormActivityNew mContext, CollectionChequeNewAdapter headerAdapter, CollectionInvoiceChequeAdapter invoiceAdapter, int idHeader, int invoicePosition, List<Material> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
