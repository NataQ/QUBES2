...
public class SpinnerProductReturnAdapter extends RecyclerView.Adapter<SpinnerProductReturnAdapter.Holder> implements Filterable {
    ...
    public SpinnerProductReturnAdapter(ReturnAddActivity mContext, List<Material> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
