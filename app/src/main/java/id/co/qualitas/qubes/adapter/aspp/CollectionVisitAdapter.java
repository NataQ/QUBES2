...
public class CollectionVisitAdapter extends RecyclerView.Adapter<CollectionVisitAdapter.Holder> implements Filterable {
    ...
    public CollectionVisitAdapter(CollectionVisitActivity mContext, List<Invoice> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.aspp_row_view_collection_visit, parent, false);
