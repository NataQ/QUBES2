...
public class CollectionInvoiceTransferAdapter extends RecyclerView.Adapter<CollectionInvoiceTransferAdapter.Holder> implements Filterable {
    ...
    CollectionTransferNewAdapter headerAdapter;
    int idHeader;

    public CollectionInvoiceTransferAdapter(CollectionFormActivityNew mContext, CollectionTransferNewAdapter headerAdapter, int idHeader, List<Invoice> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
    ...
    public void onBindViewHolder(Holder holder, int pos) {
        ...
        mAdapter = new CollectionItemTransferAdapter(mContext, headerAdapter, CollectionInvoiceTransferAdapter.this, idHeader, holder.getAbsoluteAdapterPosition(), mFilteredList.get(holder.getAbsoluteAdapterPosition()).getMaterialList(), header -> {
