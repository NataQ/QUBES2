...
import id.co.qualitas.qubes.adapter.aspp.UnloadingDetailAdapter;
...
public class UnloadingDetailActivity extends BaseActivity {
    private UnloadingDetailAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aspp_activity_unloading_detail);

        init();
        initialize();
        initData();

        mAdapter = new UnloadingDetailAdapter(this, mList, header -> {
