...
public class SpinnerProductStockRequestEditAdapter extends RecyclerView.Adapter<SpinnerProductStockRequestEditAdapter.Holder> implements Filterable {
    ...
    public SpinnerProductStockRequestEditAdapter(StockRequestEditActivity mContext, List<Material> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
