...
public class CoverageFragment extends BaseFragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imgDirect = rootView.findViewById(R.id.imgDirect);
...
//            marker.showInfoWindow();
    ...
    private Bitmap getMarkerBitmapFromView(Customer cust) {
        ...
        if (cust.isRoute()) {
            imgStore.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.ic_store_test));
        } else {
            imgStore.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.ic_store_test2));
        }
