...
public class OrderDetailDiscountAdapter extends RecyclerView.Adapter<OrderDetailDiscountAdapter.Holder> implements Filterable {
    ...
    public OrderDetailDiscountAdapter(OrderDetailActivity mContext, List<Discount> mList, OnAdapterListener onAdapterListener) {
        if (mList != null) {
            this.mList = mList;
