...
public class TimerFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        llCreditInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragment = new CreditInfoFragment();
                setContent(fragment);
            }
        });
    ...
    public static void setPlayPause() {
        if (Helper.getItemParam(Constants.PAUSE) != null) {
            ...
            btnPause.setImageDrawable(btnPause.getContext().getResources().getDrawable(R.drawable.ic_play));
            ...
            timerValue.start();
            Helper.resume = false;
            btnPause.setImageDrawable(btnPause.getContext().getResources().getDrawable(R.drawable.pause));
        }
    }
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (outletResponseArrayList != null && !outletResponseArrayList.isEmpty()) {
                    ...
                    if (flag_checked_in == 1) {
                        Toast.makeText(getContext(), getString(R.string.string_notice_checked_in).concat(outlet), Toast.LENGTH_SHORT).show();
                        flag_checked_in = 0;
                    } else {
